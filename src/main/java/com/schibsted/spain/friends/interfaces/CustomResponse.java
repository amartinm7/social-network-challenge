...
public class CustomResponse {
    ...
    public static ResponseEntity<ResponseMessage> getOKMessage (User user, ResponseMessage.Action action){
        final ResponseMessage<User> responseMessage = new ResponseMessage<>(user, HttpStatus.OK.value(), action);
        return new ResponseEntity(responseMessage, HttpStatus.OK );
    }

    public static ResponseEntity<ResponseMessage> getBadRequestMessage (ResponseMessage.Action action){
